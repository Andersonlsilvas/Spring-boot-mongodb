...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c1 = new CommentDTO("Boa viagem mano", sdf.parse("16/03/2024"), new AuthorDTO(alex));
		CommentDTO c2 = new CommentDTO("Aproveita", sdf.parse("18/03/2024"), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Tenha um ótimo dia", sdf.parse("14/03/2024"), new AuthorDTO(alex));
